...
def bench_checkpoint(
    cfg_path, weight_path, device, dtype, raw_img_size, input_img_size, iters, warmup
):
    ...
    # Monkey-patch-free staged timing: replicate infer() internals.
    t = []
...
def main():
    ...
    parser.add_argument("--weight_path", type=str, default="weights/p2pnet/cutout.pth")
